...
export async function POST(request: NextRequest) {
  try {
    ...
    globalExecutionState = {
      isRunning: true,
      phase: 'Iniciando auditoria de fluxos...',
      progress: '0/15',
      persona: '',
      error: null
    }
    ...
    setTimeout(() => {
      globalExecutionState.phase = 'Validando fluxos de trabalho...'
      console.log('🔄 Status atualizado:', globalExecutionState)
    }, 2000)

    setTimeout(() => {
      globalExecutionState.phase = 'Comparando com metas estabelecidas...'
      globalExecutionState.progress = '8/15'
      console.log('🔄 Status atualizado:', globalExecutionState)
    }, 4000)

    setTimeout(() => {
      globalExecutionState.phase = 'Identificando melhorias...'
    ...
    return NextResponse.json({ 
      success: true, 
      message: 'Script de auditoria iniciado com sucesso',
