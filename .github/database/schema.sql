...
CREATE TABLE public.automation_opportunities (
  ...
  automation_feasibility text CHECK (automation_feasibility = ANY (ARRAY['low'::text, 'medium'::text, 'high'::text])),
  workflow_type text CHECK (workflow_type = ANY (ARRAY['webhook'::text, 'cron'::text, 'event'::text, 'manual'::text])),
  required_integrations ARRAY DEFAULT '{}'::text[],
  workflow_steps jsonb DEFAULT '[]'::jsonb,
  dependencies ARRAY DEFAULT '{}'::uuid[],
  estimated_time_saved_per_execution interval,
  roi_potential text CHECK (roi_potential = ANY (ARRAY['low'::text, 'medium'::text, 'high'::text])),
  ...
  CONSTRAINT automation_opportunities_empresa_id_fkey1 FOREIGN KEY (empresa_id) REFERENCES public.empresas(id),
  CONSTRAINT automation_opportunities_persona_id_fkey1 FOREIGN KEY (persona_id) REFERENCES public.personas(id)
);
CREATE TABLE public.avatares_multimedia (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  empresa_id uuid NOT NULL,
  avatar_type character varying NOT NULL CHECK (avatar_type::text = ANY (ARRAY['photo'::character varying, 'video'::character varying, 'animated_gif'::character varying, '3d_render'::character varying, 'illustration'::character varying]::text[])),
  avatar_category character varying DEFAULT 'profile'::character varying,
  personas_ids ARRAY NOT NULL DEFAULT ARRAY[]::uuid[],
  ...
  background_type character varying,
  background_color character varying,
  lighting_setup character varying,
  use_cases ARRAY DEFAULT ARRAY[]::text[],
  tags ARRAY DEFAULT ARRAY[]::text[],
  is_public boolean DEFAULT false,
  is_approved boolean DEFAULT false,
  approved_by uuid,
  approved_at timestamp with time zone,
  parent_avatar_id uuid,
  variation_type character varying,
  version integer DEFAULT 1,
  status character varying DEFAULT 'pending'::character varying CHECK (status::text = ANY (ARRAY['pending'::character varying, 'generating'::character varying, 'processing'::character varying, 'completed'::character varying, 'failed'::character varying, 'archived'::character varying]::text[])),
  generation_service character varying,
  generation_attempts integer DEFAULT 0,
  generation_started_at timestamp with time zone,
  generation_completed_at timestamp with time zone,
  generation_error text,
  external_service_id character varying,
  ...
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT avatares_multimedia_pkey PRIMARY KEY (id),
  CONSTRAINT avatares_multimedia_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id),
  CONSTRAINT avatares_multimedia_approved_by_fkey FOREIGN KEY (approved_by) REFERENCES public.personas(id),
  CONSTRAINT avatares_multimedia_parent_avatar_id_fkey FOREIGN KEY (parent_avatar_id) REFERENCES public.avatares_multimedia(id)
);
...
CREATE TABLE public.empresas (
  ...
  cargos_necessarios jsonb DEFAULT '[]'::jsonb,
  equipe_gerada boolean DEFAULT false,
  CONSTRAINT empresas_pkey PRIMARY KEY (id)
);
CREATE TABLE public.empresas_blocos_funcionais (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  empresa_id uuid,
  nome text NOT NULL,
  objetivo text,
  ...
  personas_ids ARRAY,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT empresas_blocos_funcionais_pkey PRIMARY KEY (id),
  CONSTRAINT empresas_blocos_funcionais_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id)
);
CREATE TABLE public.empresas_governanca (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  empresa_id uuid,
  tipo text,
  area text,
  quem_persona_id uuid,
  descricao text,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT empresas_governanca_pkey PRIMARY KEY (id),
  CONSTRAINT empresas_governanca_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id),
  CONSTRAINT empresas_governanca_quem_persona_id_fkey FOREIGN KEY (quem_persona_id) REFERENCES public.personas(id)
);
CREATE TABLE public.empresas_missao (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  empresa_id uuid,
  missao_operacional text,
  visao text,
  valores ARRAY,
  proposta_valor text,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT empresas_missao_pkey PRIMARY KEY (id),
  CONSTRAINT empresas_missao_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id)
);
CREATE TABLE public.empresas_objetivos_estrategicos (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  empresa_id uuid,
  titulo text NOT NULL,
  descricao text,
  ...
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT empresas_objetivos_estrategicos_pkey PRIMARY KEY (id),
  CONSTRAINT empresas_objetivos_estrategicos_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id)
);
CREATE TABLE public.empresas_okrs (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  empresa_id uuid,
  ...
  prazo date,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT empresas_okrs_pkey PRIMARY KEY (id),
  CONSTRAINT empresas_okrs_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id),
  CONSTRAINT empresas_okrs_objetivo_estrategico_id_fkey FOREIGN KEY (objetivo_estrategico_id) REFERENCES public.empresas_objetivos_estrategicos(id),
  CONSTRAINT empresas_okrs_owner_persona_id_fkey FOREIGN KEY (owner_persona_id) REFERENCES public.personas(id)
);
CREATE TABLE public.empresas_scripts_status (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  empresa_id uuid NOT NULL,
  ...
  error_message text,
  CONSTRAINT empresas_scripts_status_pkey PRIMARY KEY (id)
);
CREATE TABLE public.empresas_value_stream (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  empresa_id uuid,
  estagio text NOT NULL,
  descricao text,
  metricas_chave jsonb,
  responsavel_persona_id uuid,
  ordem integer,
  created_at timestamp with time zone DEFAULT now(),
  CONSTRAINT empresas_value_stream_pkey PRIMARY KEY (id),
  CONSTRAINT empresas_value_stream_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id),
  CONSTRAINT empresas_value_stream_responsavel_persona_id_fkey FOREIGN KEY (responsavel_persona_id) REFERENCES public.personas(id)
);
...
CREATE TABLE public.knowledge_chunks (
  ...
  CONSTRAINT knowledge_chunks_persona_id_fkey FOREIGN KEY (persona_id) REFERENCES public.personas(id)
);
...
CREATE TABLE public.personas (
  ...
  idiomas jsonb DEFAULT '["Português"]'::jsonb,
  nacionalidade text,
  genero character varying,
  biografia_resumida text,
  avatar_image_url text,
  avatar_image_generated_at timestamp without time zone,
  avatar_image_prompt text,
  bloco_funcional_id uuid,
  bloco_funcional_nome text,
  okr_owner_ids ARRAY,
  responsabilidade_resultado text,
  metricas_responsabilidade ARRAY,
  nivel_hierarquico text CHECK (nivel_hierarquico = ANY (ARRAY['gerencial'::text, 'especialista'::text, 'operacional'::text])),
  CONSTRAINT personas_pkey PRIMARY KEY (id),
  CONSTRAINT personas_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id),
  CONSTRAINT personas_bloco_funcional_id_fkey FOREIGN KEY (bloco_funcional_id) REFERENCES public.empresas_blocos_funcionais(id)
);
CREATE TABLE public.personas_atribuicoes (
  ...
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  use_subsystem boolean DEFAULT false,
  which_subsystem text,
  how_use text,
...
CREATE TABLE public.personas_auditorias (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  persona_id uuid NOT NULL,
  audit_type text NOT NULL DEFAULT 'completeness_check'::text,
  ...
  created_at timestamp without time zone DEFAULT now(),
  CONSTRAINT personas_auditorias_pkey PRIMARY KEY (id),
  CONSTRAINT personas_audit_logs_persona_id_fkey FOREIGN KEY (persona_id) REFERENCES public.personas(id)
);
CREATE TABLE public.personas_automation_opportunities (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  empresa_id uuid NOT NULL,
  persona_id uuid NOT NULL,
  task_id uuid,
  automation_score integer CHECK (automation_score >= 0 AND automation_score <= 100),
  automation_feasibility text CHECK (automation_feasibility = ANY (ARRAY['high'::text, 'medium'::text, 'low'::text, 'none'::text])),
  workflow_type text CHECK (workflow_type = ANY (ARRAY['webhook'::text, 'cron'::text, 'event'::text, 'manual'::text])),
  required_integrations ARRAY,
  workflow_steps jsonb,
  dependencies ARRAY,
  estimated_time_saved_per_execution interval,
  roi_potential text CHECK (roi_potential = ANY (ARRAY['high'::text, 'medium'::text, 'low'::text])),
  complexity text CHECK (complexity = ANY (ARRAY['simple'::text, 'medium'::text, 'complex'::text])),
  reasoning text,
  llm_prompt_used text,
  llm_response_raw jsonb,
  status text DEFAULT 'analyzed'::text CHECK (status = ANY (ARRAY['analyzed'::text, 'workflow_created'::text, 'active'::text, 'paused'::text, 'rejected'::text, 'archived'::text])),
  workflow_id uuid,
  rejection_reason text,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  analyzed_by text DEFAULT 'LLM'::text,
  analyzed_version text,
  task_title text,
  task_description text,
  task_frequency text,
  CONSTRAINT personas_automation_opportunities_pkey PRIMARY KEY (id),
  CONSTRAINT automation_opportunities_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id),
  CONSTRAINT automation_opportunities_persona_id_fkey FOREIGN KEY (persona_id) REFERENCES public.personas(id)
);
CREATE TABLE public.personas_avatares (
  ...
  background_tipo character varying,
  servico_usado character varying DEFAULT 'gemini_ai'::character varying,
  versao character varying DEFAULT 'v1.0'::character varying,
  ...
  avatar_thumbnail_local_path text,
  CONSTRAINT personas_avatares_pkey PRIMARY KEY (id),
  CONSTRAINT fk_personas_avatares_persona_id FOREIGN KEY (persona_id) REFERENCES public.personas(id)
);
...
CREATE TABLE public.personas_communications (
  ...
  receiver_persona_id uuid NOT NULL,
  communication_type USER-DEFINED NOT NULL,
  priority USER-DEFINED DEFAULT 'normal'::communication_priority,
  subject character varying NOT NULL,
  ...
  status USER-DEFINED DEFAULT 'pending'::communication_status,
  read_at timestamp with time zone,
  deadline timestamp with time zone,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT personas_communications_pkey PRIMARY KEY (id),
  CONSTRAINT personas_communications_sender_persona_id_fkey FOREIGN KEY (sender_persona_id) REFERENCES public.personas(id),
  CONSTRAINT personas_communications_receiver_persona_id_fkey FOREIGN KEY (receiver_persona_id) REFERENCES public.personas(id)
);
CREATE TABLE public.personas_competencias (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  persona_id uuid NOT NULL UNIQUE,
  ...
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT personas_competencias_pkey PRIMARY KEY (id),
  CONSTRAINT personas_competencias_persona_id_fkey FOREIGN KEY (persona_id) REFERENCES public.personas(id)
);
CREATE TABLE public.personas_machine_learning (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  persona_id uuid NOT NULL,
  model_type text NOT NULL DEFAULT 'behavior_prediction'::text,
  training_data jsonb NOT NULL,
  model_parameters jsonb NOT NULL,
  performance_metrics jsonb NOT NULL,
  predictions jsonb,
  optimization_suggestions jsonb,
  last_trained_at timestamp without time zone DEFAULT now(),
  created_at timestamp without time zone DEFAULT now(),
  updated_at timestamp without time zone DEFAULT now(),
  CONSTRAINT personas_machine_learning_pkey PRIMARY KEY (id),
  CONSTRAINT personas_ml_models_persona_id_fkey FOREIGN KEY (persona_id) REFERENCES public.personas(id)
);
CREATE TABLE public.personas_metas (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  persona_id uuid NOT NULL,
  titulo text NOT NULL,
  descricao text,
  categoria text DEFAULT 'performance'::text,
  valor_alvo numeric NOT NULL,
  valor_atual numeric DEFAULT 0,
  unidade_medida text,
  data_inicio date DEFAULT CURRENT_DATE,
  data_prazo date NOT NULL,
  status text DEFAULT 'nao_iniciada'::text,
  progresso_percentual integer DEFAULT 0 CHECK (progresso_percentual >= 0 AND progresso_percentual <= 100),
  prioridade integer DEFAULT 2 CHECK (prioridade >= 1 AND prioridade <= 3),
  responsavel text,
  observacoes text,
  vinculada_kpi text,
  created_at timestamp without time zone DEFAULT now(),
  updated_at timestamp without time zone DEFAULT now(),
  CONSTRAINT personas_metas_pkey PRIMARY KEY (id),
  CONSTRAINT personas_metas_persona_id_fkey FOREIGN KEY (persona_id) REFERENCES public.personas(id)
);
CREATE TABLE public.personas_tasks (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  empresa_id uuid,
  persona_id uuid,
  ...
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  procedimento_execucao jsonb DEFAULT '[]'::jsonb,
  CONSTRAINT personas_tasks_pkey PRIMARY KEY (id),
...
CREATE TABLE public.personas_workflows (
  id uuid NOT NULL DEFAULT uuid_generate_v4(),
  empresa_id uuid NOT NULL,
  persona_id uuid NOT NULL,
  workflow_name text NOT NULL,
  ...
  linked_tasks ARRAY,
  opportunity_id uuid,
  source_type text DEFAULT 'task-driven'::text CHECK (source_type = ANY (ARRAY['task-driven'::text, 'template'::text, 'manual'::text, 'imported'::text])),
  status text DEFAULT 'draft'::text CHECK (status = ANY (ARRAY['draft'::text, 'active'::text, 'paused'::text, 'archived'::text, 'error'::text, 'deleted'::text])),
  is_active_in_n8n boolean DEFAULT false,
  executions_count integer DEFAULT 0 CHECK (executions_count >= 0),
  success_count integer DEFAULT 0 CHECK (success_count >= 0),
  error_count integer DEFAULT 0 CHECK (error_count >= 0),
  last_execution_at timestamp with time zone,
  last_execution_status text CHECK (last_execution_status = ANY (ARRAY['success'::text, 'error'::text, 'running'::text, 'waiting'::text, 'canceled'::text])),
  average_execution_time interval,
  total_time_saved interval,
  estimated_cost_saving_monthly numeric,
  last_sync_with_n8n_at timestamp with time zone,
  ...
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  created_by text DEFAULT 'VCM Auto-Generator'::text,
  last_modified_by text,
  version integer DEFAULT 1,
  CONSTRAINT personas_workflows_pkey PRIMARY KEY (id),
  CONSTRAINT personas_workflows_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id),
  CONSTRAINT personas_workflows_persona_id_fkey FOREIGN KEY (persona_id) REFERENCES public.personas(id)
);
...
CREATE TABLE public.subsistemas (
  ...
  icone character varying DEFAULT 'Box'::character varying,
  cor character varying DEFAULT '#3B82F6'::character varying,
  status character varying DEFAULT 'ativo'::character varying CHECK (status::text = ANY (ARRAY['ativo'::character varying, 'inativo'::character varying, 'desenvolvimento'::character varying, 'arquivado'::character varying]::text[])),
  prioridade integer DEFAULT 0,
  total_personas integer DEFAULT 0,
  total_tarefas integer DEFAULT 0,
  total_workflows integer DEFAULT 0,
  configuracoes jsonb DEFAULT '{}'::jsonb,
  integracao_config jsonb DEFAULT '{}'::jsonb,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  created_by character varying,
  updated_by character varying,
  funcionalidades ARRAY,
  metricas_principais ARRAY,
  ordem_exibicao integer DEFAULT 0,
  CONSTRAINT subsistemas_pkey PRIMARY KEY (id),
  CONSTRAINT subsistemas_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id)
);
...
CREATE TABLE public.task_execution_analytics (
  ...
  CONSTRAINT task_execution_analytics_task_id_fkey FOREIGN KEY (task_id) REFERENCES public.personas_tasks(id),
  CONSTRAINT task_execution_analytics_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id)
);
CREATE TABLE public.task_persona_assignments (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  task_id uuid NOT NULL,
  persona_id uuid NOT NULL,
  assigned_at timestamp with time zone NOT NULL DEFAULT now(),
  assigned_by uuid,
  status character varying DEFAULT 'pending'::character varying CHECK (status::text = ANY (ARRAY['pending'::character varying, 'in_progress'::character varying, 'completed'::character varying, 'skipped'::character varying]::text[])),
  completed_at timestamp with time zone,
  notes text,
  created_at timestamp with time zone NOT NULL DEFAULT now(),
  updated_at timestamp with time zone NOT NULL DEFAULT now(),
  CONSTRAINT task_persona_assignments_pkey PRIMARY KEY (id),
  CONSTRAINT task_persona_assignments_task_id_fkey FOREIGN KEY (task_id) REFERENCES public.personas_tasks(id),
  CONSTRAINT task_persona_assignments_persona_id_fkey FOREIGN KEY (persona_id) REFERENCES public.personas(id)
);
CREATE TABLE public.task_supervision_chains (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  task_template_code character varying NOT NULL,
  functional_area character varying,
  executor_role character varying NOT NULL,
  supervisor_role character varying NOT NULL,
  executor_level USER-DEFINED NOT NULL,
  supervisor_level USER-DEFINED NOT NULL,
  supervision_type USER-DEFINED NOT NULL,
  trigger_criteria USER-DEFINED NOT NULL,
  trigger_rules jsonb,
  value_threshold_min numeric,
  value_threshold_max numeric,
  response_time_hours integer DEFAULT 24,
  escalation_enabled boolean DEFAULT true,
  escalation_to_role character varying,
  escalation_to_level USER-DEFINED,
  is_active boolean DEFAULT true,
  priority integer DEFAULT 1,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT task_supervision_chains_pkey PRIMARY KEY (id)
);
CREATE TABLE public.task_supervision_logs (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  supervision_chain_id uuid,
  task_id character varying NOT NULL,
  communication_id uuid,
  executor_persona_id uuid NOT NULL,
  supervisor_persona_id uuid NOT NULL,
  task_template_code character varying NOT NULL,
  task_title character varying NOT NULL,
  task_value numeric,
  task_risk_level character varying,
  task_context jsonb,
  supervision_type USER-DEFINED NOT NULL,
  requested_at timestamp with time zone DEFAULT now(),
  deadline timestamp with time zone,
  decision USER-DEFINED DEFAULT 'pending'::supervision_decision,
  decision_notes text,
  modifications_requested jsonb,
  decided_at timestamp with time zone,
  was_escalated boolean DEFAULT false,
  escalated_to_persona_id uuid,
  ...
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT task_supervision_logs_pkey PRIMARY KEY (id),
  CONSTRAINT task_supervision_logs_supervision_chain_id_fkey FOREIGN KEY (supervision_chain_id) REFERENCES public.task_supervision_chains(id),
  CONSTRAINT task_supervision_logs_communication_id_fkey FOREIGN KEY (communication_id) REFERENCES public.personas_communications(id),
  CONSTRAINT task_supervision_logs_executor_persona_id_fkey FOREIGN KEY (executor_persona_id) REFERENCES public.personas(id),
  CONSTRAINT task_supervision_logs_supervisor_persona_id_fkey FOREIGN KEY (supervisor_persona_id) REFERENCES public.personas(id),
  CONSTRAINT task_supervision_logs_escalated_to_persona_id_fkey FOREIGN KEY (escalated_to_persona_id) REFERENCES public.personas(id)
);
...
CREATE TABLE public.user_interventions (
  ...
  intervention_type USER-DEFINED NOT NULL,
  command_template character varying,
  command_parameters jsonb NOT NULL CHECK (jsonb_typeof(command_parameters) = 'object'::text),
  target_task_id character varying,
  target_persona_id uuid,
  related_supervision_log_id uuid,
  is_valid boolean DEFAULT false,
  validation_errors jsonb,
  status USER-DEFINED DEFAULT 'received'::intervention_status,
  ...
  metrics_confirmed_at timestamp with time zone,
  actual_metrics jsonb,
  n8n_workflow_id character varying,
  n8n_execution_id character varying,
  n8n_status character varying,
  source character varying DEFAULT 'web_ui'::character varying,
  ip_address inet,
  user_agent text,
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT user_interventions_pkey PRIMARY KEY (id),
  CONSTRAINT user_interventions_target_persona_id_fkey FOREIGN KEY (target_persona_id) REFERENCES public.personas(id),
  CONSTRAINT user_interventions_related_supervision_log_id_fkey FOREIGN KEY (related_supervision_log_id) REFERENCES public.task_supervision_logs(id)
);
...
CREATE TABLE public.workplace_scenes (
  id uuid NOT NULL DEFAULT gen_random_uuid(),
  empresa_id uuid NOT NULL,
  ...
  generation_service character varying DEFAULT 'midjourney'::character varying,
  generation_params jsonb DEFAULT '{}'::jsonb,
  status character varying DEFAULT 'pending'::character varying CHECK (status::text = ANY (ARRAY['pending'::character varying, 'generating'::character varying, 'completed'::character varying, 'failed'::character varying, 'archived'::character varying]::text[])),
  version integer DEFAULT 1,
  is_approved boolean DEFAULT false,
  approved_by uuid,
  approved_at timestamp with time zone,
  midjourney_message_id character varying,
  generation_attempts integer DEFAULT 0,
  generation_started_at timestamp with time zone,
  generation_completed_at timestamp with time zone,
  generation_error text,
  ...
  created_at timestamp with time zone DEFAULT now(),
  updated_at timestamp with time zone DEFAULT now(),
  CONSTRAINT workplace_scenes_pkey PRIMARY KEY (id),
  CONSTRAINT workplace_scenes_empresa_id_fkey FOREIGN KEY (empresa_id) REFERENCES public.empresas(id),
  CONSTRAINT workplace_scenes_approved_by_fkey FOREIGN KEY (approved_by) REFERENCES public.personas(id)
);